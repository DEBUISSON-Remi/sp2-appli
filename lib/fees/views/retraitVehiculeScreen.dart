...
class RetraitVehiculeScreen extends StatefulWidget {
  ...
  @override
  _RetraitVehiculeScreenState createState() => _RetraitVehiculeScreenState();
}
    ...
    final table1 = Table(
      ...
      children: [
        ...
        TableRow(children: [
          Center(
            child: TextField(
              decoration: new InputDecoration(labelText: "Entrez le nombre de kilomètres"),
          ...
          Center(
              child: DateTimePickerFormField(
                ...
                onChanged: (dt) {
                  setState(() => date = dt);
                  print('Séléctionnez la date : $date');
                },
              ),
          ),
        ])
